...
def test_model():
    ...
    dataset_name = 'NBU-WLF1.0'
    scene_list = ['I01C00', 'I02C00', 'I03C00', 'I04C00', 'I05C00',
                  'I06C00', 'I07C00', 'I08C00', 'I09C00', 'I10C00']
    test_scene_num = 2
    distorted_num = 5
    scene_num = 10
    Dist_DICT = {'JPEG2000': ['01', '02', '03', '04', '05'], 'JPEGPleno': ['06', '07', '08', '09', '10'],
                 'HEVC': ['11', '12', '13', '14', '15'], 'SADN': ['16', '17', '18', '19', '20']}
    dist = 'SADN'   # JPEG2000, JPEGPleno, HEVC, SADN
    ...
    for id, model_name in enumerate(test_scene_id_list):
        ...
        for test_scene in test_scene_id:
            ...
            for test_image in image_list:
                ...
                if dataset_name == 'NBU-WLF1.0':
                    if str(test_image.split('C')[1]) not in Dist_DICT[dist]: continue
                else:
    ...
    f = h5py.File('./Results/EPPVS-BWLFQ_result_' + dataset_name + '_' + dist + '.h5', 'w')
